...
local Library = {
    ...
    --// Animations \\-- (Silky smooth premium timing)
    TweenInfo = TweenInfo.new(0.18, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out),

    TabTransitionInfo = TweenInfo.new(0.32, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out),
    TabSwipeOffset = 16,
    TabSwipeFrom = "bottom",

    WindowAnimationInfo = TweenInfo.new(0.48, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out),
    DropdownTransitionInfo = TweenInfo.new(0.26, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out),
    KeyPickerTransitionInfo = TweenInfo.new(0.20, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out),

    GroupboxTweenInfo = TweenInfo.new(0.28, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out),
    RotatingChevronTweenInfo = TweenInfo.new(0.36, Enum.EasingStyle.Back, Enum.EasingDirection.Out),
    ...
    OriginalMinSize = Vector2.new(540, 420),
    MinSize = Vector2.new(540, 420),
    DPIScale = 1,
    CornerRadius = 14,    -- Rounder, more premium macOS-style corners

    --// Scheme \\--
    IsLightTheme = false,
    Scheme = {
        -- ╔══════════════════════════════════════════╗
        -- ║   AURORA DARK  ·  Premium UI Palette     ║
        -- ╚══════════════════════════════════════════╝
        BackgroundColor = Color3.fromRGB(10, 10, 18),      -- Near-black deep space
        MainColor       = Color3.fromRGB(18, 18, 30),      -- Elevated surface
        AccentColor     = Color3.fromRGB(124, 77, 255),    -- Vivid violet accent
        OutlineColor    = Color3.fromRGB(40, 36, 62),      -- Subtle purple-tinted border
        FontColor       = Color3.fromRGB(230, 224, 255),   -- Soft lavender white
        Font            = Font.fromEnum(Enum.Font.GothamMedium),

        RedColor        = Color3.fromRGB(255, 55, 95),     -- Vivid rose-red
        DestructiveColor= Color3.fromRGB(255, 55, 95),
        DarkColor       = Color3.fromRGB(5, 5, 10),        -- True black shadow
...
if RunService:IsStudio() then
    if UserInputService.TouchEnabled and not UserInputService.MouseEnabled then
        ...
        Library.OriginalMinSize = Vector2.new(520, 400)
    end
else
    pcall(function()
...
function Library:AddOutline(Frame: GuiObject)
    -- Inner highlight border (subtle violet glow)
    ...
    -- Outer deep shadow for depth & elevation
...
function Library:CreateWindow(WindowInfo)
    ...
    Library.TabTransitionInfo = TweenInfo.new(
        math.max(0, WindowInfo.TabTransitionTime or 0.30),
    ...
    do
        ...
        --// Top Bar \\- (Taller for premium macOS feel)
        TopBar = New("Frame", {
            BackgroundTransparency = 1,
        ...
        WindowTitle = New("TextLabel", {
            ...
            TextSize = 22,    -- Bigger, more premium title
            Parent = TitleHolder,
        })
        ...
        Tabs = New("ScrollingFrame", {
            ...
            Size = UDim2.new(0, InitialLeftWidth, 1, -74),
            Parent = MainFrame,
        })
        New("UIListLayout", {
            Parent = Tabs,
    ...
    function Window:AddTab(...)
        ...
        do
            TabButton = New("TextButton", {
                BackgroundColor3 = "MainColor",
                BackgroundTransparency = 1,
                Size = UDim2.new(1, 0, 0, 44),   -- Taller, premium tab buttons
                Text = "",
                Parent = Tabs,
            })
            local ButtonPadding = New("UIPadding", {
                PaddingBottom = UDim.new(0, IsCompact and 7 or 12),
                PaddingLeft = UDim.new(0, IsCompact and 7 or 14),
                PaddingRight = UDim.new(0, IsCompact and 7 or 14),
                PaddingTop = UDim.new(0, IsCompact and 7 or 12),
                Parent = TabButton,
            })
        ...
        function Tab:AddGroupbox(Info)
            ...
            function Groupbox:Resize()
                ...
                local TargetSize = UDim2.new(1, 0, 0, if Groupbox.Collapsed then 38 else (GroupboxList.AbsoluteContentSize.Y / Library.DPIScale) + 57)
