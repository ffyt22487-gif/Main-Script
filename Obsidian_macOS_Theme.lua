...
local Library = {
    ...
    Scheme = {
        ...
        MainColor = Color3.fromRGB(42, 42, 60),
        AccentColor = Color3.fromRGB(10, 132, 255),
        OutlineColor = Color3.fromRGB(58, 58, 78),
        FontColor = Color3.fromRGB(235, 235, 245),
        Font = Font.fromEnum(Enum.Font.Gotham),

        RedColor = Color3.fromRGB(255, 69, 58),
        DestructiveColor = Color3.fromRGB(255, 69, 58),
        DarkColor = Color3.fromRGB(20, 20, 32),
